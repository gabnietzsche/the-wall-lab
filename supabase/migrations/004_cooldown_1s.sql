-- Migration 004 — Cooldown tra colpi: da 2s a 1s
--
-- Solo cambio: hit_brick ora rifiuta i colpi entro 0.9s dall'ultimo
-- (con buffer 100ms sul client che mostra 1000ms).
...
begin
  ...
  -- COOLDOWN 1s (server tolera fino a 900ms; client mostra 1000ms)
